    ...
    <SiteFrame>
      <main className="container-page pb-20 pt-32">
        ...
        <p className="mt-3">
          ...
          заявкам, применяет серверную проверку данных формы, передает обращения через защищенное
          соединение в Telegram и хранит данные только в объеме, необходимом для обработки
          обращения.
        </p>

        <h2 className="mt-8 text-2xl font-semibold text-white">9. Cookies и аналитика</h2>
        <p className="mt-3">
          Сайт может использовать технические cookies, необходимые для корректной работы страниц.
          Если будут подключены системы аналитики, они могут собирать
